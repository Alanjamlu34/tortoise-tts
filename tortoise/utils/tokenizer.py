...
_dollars_re = re.compile(r'Rp([0-9\.\,]*[0-9]+)')
...
def _expand_ordinal(m):
  return _inflect.number_to_words(m.group(0), lang='id')
...
def _expand_number(m):
  ...
  if num > 1000 and num < 3000:
    if num == 2000:
      ...
      return 'dua ribu ' + _inflect.number_to_words(num % 100, lang='id')
    elif num % 100 == 0:
      return _inflect.number_to_words(num // 100, lang='id') + ' ratus'
    else:
      return _inflect.number_to_words(num, andword='', zero='oh', group=2, lang='id').replace(', ', ' ')
  else:
    return _inflect.number_to_words(num, andword='', lang='id')
